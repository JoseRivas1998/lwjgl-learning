...
public class Lab07 extends ApplicationAdapter {
    ...
    public void create() {
        this.shaderPrograms.put("uvProgram", ShaderProgram.buildShader(
                FileUtils.readFile("sample_shaders/lab07/vert.uv.glsl"),
                FileUtils.readFile("sample_shaders/lab07/frag.uv.glsl")
        ));
        this.shaderPrograms.put("rgbProgram", ShaderProgram.buildShader(
                FileUtils.readFile("sample_shaders/lab07/vert.rgb.glsl"),
                FileUtils.readFile("sample_shaders/lab07/frag.rgb.glsl")
        ));
    ...
    public static void main(String[] args) {
        new LWJGLApplication(new Lab07());
    }
